...
class ExclamationMarkTest {
    ...
    private ExclamationMark validator;

    @BeforeEach
    void setUp() {
        validator = new ExclamationMark();
    }

    @Test
    void consistentExclamation() {
        var original = "Hello!";
        var translated = "Hola!";
    ...
    void excludeLanguages() {
        assertThat(validator.excludeLanguages()).containsExactlyInAnyOrder("hy", "bo", "es", "dz", "gl");
    }
}