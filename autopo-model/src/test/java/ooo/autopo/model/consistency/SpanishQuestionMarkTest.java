 ...
 */
class SpanishQuestionMarkTest {
    private SpanishQuestionMark validator;

    @BeforeEach
    void setUp() {
        validator = new SpanishQuestionMark();
    }
    ...
    @Test
    void inconsistentQuestionMarkMissingStart() {
        var original = "Are you okay?";
        var translated = "Estás bien?";
        var result = validator.validate(original, translated, "es");
        assertNotEquals(ConsistencyValidator.VALID, result);
    ...
    @Test
    void inconsistentQuestionMarkMissingEnd() {
        var original = "Are you okay?";
        var translated = "¿Estás bien";
        var result = validator.validate(original, translated, "es");
        assertNotEquals(ConsistencyValidator.VALID, result);
