 ...
 */
class FullStopTest {
    private FullStop validator;

    @BeforeEach
    void setUp() {
        validator = new FullStop();
    }
    ...
    void specificFullStopEquivalence() {
        ...
        var original = "Hello.";
        String result = validator.validate(original, translated, "ja");
        assertEquals(ConsistencyValidator.VALID, result);
    }
    ...
    void excludeLanguages() {
        assertThat(validator.excludeLanguages()).containsExactlyInAnyOrder("ar", "fa", "th", "lo", "ko");
    }
}